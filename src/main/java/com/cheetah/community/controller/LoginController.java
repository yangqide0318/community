...
import com.cheetah.community.service.LoginService;
   ...
   private LoginService loginService;
    ...
    public String register(Model model, User user) throws IllegalAccessException {
        ...
        if(map==null||map.isEmpty()){
            model.addAttribute("msg","注册成功，我们已经向您的邮箱，发送了一封激活邮件，请尽快激活");
    ...
    public String activation(Model model, @PathVariable("userId") int userId,@PathVariable("code") String code){
        ...
        if(result==ACTIVATION_SUCCESS){
            ...
            model.addAttribute("msg","激活失败，您的激活码有问题。");
            model.addAttribute("target","/index");
        }
        return "/site/operate-result";
    }
    ...
    public void getKaptcha(HttpServletResponse response /*, HttpSession session*/){
        ...
        try {
            //这个流我们没有关闭，因为整个response是由Spring容器在管理
